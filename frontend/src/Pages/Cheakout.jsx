        ...
        <div className="md:max-w-5xl max-w-xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 p-6 rounded-md">
              <h2 className="text-3xl font-bold text-slate-900">Price List</h2>
              <ul className="text-slate-900 font-medium mt-12 space-y-4">
                ...
                <li className="flex flex-wrap gap-4 text-sm border-t-2 border-gray-400 pt-2 mt-6">
                  Tax <span className="ml-auto font-bold">$10.00</span>
                </li>
                <li className="flex flex-wrap gap-4 text-sm">
                  Delivery Charge <span className="ml-auto font-bold">$10.00</span>
                </li>
                <li className="flex flex-wrap gap-4 text-sm font-bold border-t-2 border-gray-400 pt-2 mt-10">
